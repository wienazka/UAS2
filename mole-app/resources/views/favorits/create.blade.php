...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="/favorits">
                @csrf
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                          <input type="date" id="exampleFormControlInput1" class="form-control" name="date">
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="exampleFormControlInput1" class="col-sm-2 col-form-label">Notes</label>
                        <div class="col-sm-10">
                          <input type="text" id="exampleFormControlInput1" class="form-control" name="notes">
                        </div>
                      </div>
                    <div class="mb-3 row">
